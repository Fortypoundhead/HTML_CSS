<!--#include file="assets/includes/inc_header_common.asp"-->
        ...
        <div class="box100">
            ...
            <ul>
                ...
                <li>To administer a contest, promotion, survey or other site feature</li><li>To send periodic emails</li>
            </ul>
            <p>The email address you provide may be used to send you information, respond to inquiries, validate your identity, and/or other requests or questions.</p>
            ...
            <p>Please also visit our Terms and Conditions section establishing the use, disclaimers, and limitations of liability governing the use of our website at <a href="<% =CFG_BaseURL %>terms.asp" title="Terms and Conditions"><% =CFG_BaseURL %>terms.asp</a></p>
            <h3>Your Consent </h3> 
            ...
            <p>This policy was last modified on 8/1/2019.</p>
            <h3>Contacting Us </h3> 
            <p>If there are any questions regarding this privacy policy you may contact us using the information below. </p>
            <p><a href="mailto:<% =CFG_WebMasterEmail %>"><% =CFG_WebMasterEmail %></a></p>
